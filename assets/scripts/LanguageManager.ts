export class LanguageManager {
    ...
    static readonly ENGLISH  = new LanguageManager()
        ...
        .synopsisText("Coquito broke his helmet during the invasion of Earth. Assisted by some kind earthlings, he realized that he had to return the favor. He decided then to delay the invasion by taking the supplies that his colleagues brought. Without the helmet he won't be able to survive long... He has to act fast!")
        .controlsTitle("Controls")
        .controlsText("You can move Coquito with keys W, A, S and D. You can run by pressing the SHIFT key. Remember, at this time of day your colleagues can't see well with their helmet. But if you get too close, they might stop you. If they get too annoying, with the letter Q or with Click you can temporarily knock them out. Collect all the objects before it's too late.")
        .play("Play")
        .extra("Extra")
        ...
        .winExtraGame("You did it, Coquito can continue with his adventure!")
        .gameoverNormalGame("You fail to fulfill your goal. Many earthlings are now left to their own fate...")
        .gameoverExtraGame("This is the end of Coquito journey!")
        .extraTutorial("Things are getting complicated. Coquito must survive until he can be rescued, he must resist no matter what...")
        .winTitle("You did it!")
